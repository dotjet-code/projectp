          ...
          <div className="max-w-[1200px] mx-auto relative">
            ...
            <div className="mt-6 max-w-2xl">
              ...
              >
                ...
                <br />
                バトルステージごとに、主役の座を懸けて駆け上がる。上位 6 名だけが、次のバトルステージに立てる。
              </p>
              <div
        ...
        <div className="max-w-[1200px] mx-auto px-4 mt-16 space-y-16">
          ...
          <section>
            ...
            <div className="space-y-5 max-w-3xl">
              <p
                ...
                style={{ fontFamily: "var(--font-noto-serif), serif" }}
              >
                かけあがり は、<strong className="text-[#D41E28]">メンバーが毎バトルステージの成績で競い合い、上位 6 名が「PLAYER」として次のバトルステージに立つ</strong>競争型エンタメプロジェクト。1 つのバトルステージは約 1 ヶ月の競争期間。
              </p>
              <p
                className="text-base leading-relaxed text-[#111]"
                style={{ fontFamily: "var(--font-noto-serif), serif" }}
              >
                固定チームではない。バトルステージ閉幕のたびにポジションが入れ替わり、誰もが主役になれる可能性と、主役を失うリスクを同時に抱えている。
              </p>
              <p
                className="text-sm leading-relaxed text-[#4A5060]"
                style={{ fontFamily: "var(--font-noto-serif), serif" }}
              >
                勝ち取った 6 名は、次バトルステージの主役として活動する。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-6 bg-[#D41E28] text-white px-6 py-4">
              <p
                ...
                style={{ fontFamily: "var(--font-noto-serif), serif" }}
              >
                4 指標の合計ポイントが、そのバトルステージの総合順位を決める。
              </p>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-[3px] border-[#111]">
              <div className="bg-[#D41E28] text-white px-6 py-8 md:px-8 md:py-10 md:border-r-[3px] md:border-[#111]">
                ...
                >
                  ...
                  <li>— 成績が落ちれば、次バトルステージは PIT に降格</li>
                </ul>
              </div>
              <div className="bg-[#111111] text-[#F5F1E8] px-6 py-8 md:px-8 md:py-10 border-t-[3px] border-[#111] md:border-t-0">
                ...
                >
                  ...
                  <li>— 成績次第で、次バトルステージは PLAYER に昇格</li>
                </ul>
              </div>
            </div>
          ...
          <section>
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-noto-serif), serif" }}
            >
              バトルステージ閉幕時、メンバー全員が集合する特別配信番組。ここでそのバトルステージの戦いが最終確定し、次バトルステージの PLAYER / PIT 編成が発表される。
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t-[3px] border-[#111]">
              {[
                ...
                { num: "03", label: "新編成", desc: "上位 6 名が PLAYER に昇格、次バトルステージスタート" },
              ].map((item) => (
                <div
                  key={item.num}
