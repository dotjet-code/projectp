...
export async function PATCH(req: NextRequest) {
  ...
  if (typeof body.snsInstagram === "string")
    update.sns_instagram = body.snsInstagram.slice(0, 200);
  if (typeof body.snsX === "string") update.sns_x = body.snsX.slice(0, 200);
  if (typeof body.snsYoutube === "string")
    update.sns_youtube = body.snsYoutube.slice(0, 200);
  if (typeof body.snsTiktok === "string")
    update.sns_tiktok = body.snsTiktok.slice(0, 200);
